...
<body>
	<div class="body ">
			...
			<div class="container my-3">
				<div class="row p-4">
					<div
						...
						<h1 class="font-weight-bold text-10">Order Summary</h1>
					</div>
		...
		<div class="container" ng-controller="cartCtrl">
			<!-- <div class="progress-bar-custom" style="margin-right: 379px;"> -->
			...
			<div class="row">
				...
				<!-- <div class="col-md-4">
					<div class="order-summary"
						...
						<h5>Order Summary</h5>
						<p>
							Item Qty: <span class="float-end">1.00</span>
						</p>
						<p>
							Sub Total: <span class="float-end">&#8377; 2,600.00</span>
						</p>
						<hr>
				...
				<!-- Cancel Order and Contiune Button -->
				<div style="margin-top: 17px;">
					<!-- <a href="index.html" class="btn btn-danger btn-sm"
						style="background-color: #444; border-color: #444; color: white; text-decoration: none; padding: 10px;">Cancel
						Order</a> <a href="payment-option.html" class="btn btn-danger btn-sm"
						style="background-color: #444; border-color: #444; padding: 10px 16px; text-decoration: none; color: white;">
						Continue </a> -->
					<button class="btn btn-danger btn-sm" ng-click="cancelOrder()"
						style="background-color: #444; border-color: #444; color: white; text-decoration: none; padding: 10px;">
						Cancel Order</button>
					<!-- Show "Pay Now" if delivery is disabled -->
					<!-- <button class="btn btn-danger btn-sm" ng-click="payNow()"
						ng-if="!deliveryEnabled"
						style="background-color: #444; border-color: #444; padding: 10px 16px; text-decoration: none; color: white;">
						Pay Now</button>  -->
					<!-- Show "Continue" if delivery is enabled -->
					<button class="btn btn-danger btn-sm" ng-click="continuePayment()"
						style="background-color: #444; border-color: #444; padding: 10px 16px; text-decoration: none; color: white;">
						Continue</button>
				</div>
