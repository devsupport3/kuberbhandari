...
<body>
	<div class="body ">
		...
		<div ng-controller="FrontDarshanController"
			...
			<div class="container"
				ng-repeat="dailyDarshan in getAllActiveDailyDarshan | orderBy:'-dailyDarshanDate'">
				<div class="title">{{ dailyDarshan.dailyDarshanTitle }},{{
					dailyDarshan.dailyDarshanDay }}, {{ dailyDarshan.dailyDarshanDate |
					dateFormat }}</div>

				<div class="image-gallery">
					<img ng-repeat="image in dailyDarshan.dailyDarshanImages"
						ng-src="{{image.dailyDarshanImages}}" alt="Darshan Image">
				</div>
			</div>
		</div>
	</div>
