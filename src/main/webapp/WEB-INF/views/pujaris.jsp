...
<title>The Pujaris</title>

<meta name="keywords"
	content="Pujari, Pujari Kuber, Kuber Bhandari Pujaris, List of pujaris of Kuber Bhandari, Pujaris Kubereshwar Mahadev, Laghurudra, Rudrabhishek, Maharudra, Maha Mrutyunjay jaap " />
<meta name="description"
	content="Shree Kubereshwar Mahadev temple at Karnali is worshipped by inherited pujaris who own the temple for centuries.">
			...
			<div class="container my-3">
				<div class="row p-4">
					<div
						...
						<h1 class="font-weight-bold text-10">The Pujaris</h1>
					</div>
					<div class="col-md-12 align-self-center order-1">
						<ul class="breadcrumb breadcrumb-light d-block text-center">
							<li><a href="<%=request.getContextPath()%>/">Home</a></li>
							<li class="active">The Pujaris</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-center pt-5">
				<div class="col-lg-12 text-center">
					<span
						...
						data-appear-animation-delay="200">Hereditary pujaris passed
						down through the centuries</span>
					<h2 class="font-weight-bold text-10 mb-4 appear-animation"
						data-appear-animation="fadeInUpShorter"
						data-appear-animation-delay="400">Pujaris of Shree Kuber
						Bhandari, Karnali, Gujarat</h2>
					<p class="custom-font-size-2 font-weight-light appear-animation"
						data-appear-animation="fadeInUpShorter"
						data-appear-animation-delay="600">Shree Kubereshwar Mahadev
						temple at Karnali is worshipped by inherited 7 pujari families who
						own the temple for centuries.</p>
				</div>
			</div>
			<div class="row mb-5 mb-lg-0">
				<!-- <div class="row mb-5 pb-3"> -->

				<div class="col-md-3 col-lg-3 mb-5 mb-lg-0 appear-animation"
					data-appear-animation="fadeInUpShorter"
					...
					<div class="card">
						<img class="card-img-top"
							src="resources/front/img/Pujaris/Pujari-Placeholder-354-354.jpg"
							alt="Pujari Shri Arunkumar Chandraprasad Pandit">
						<div class="card-body">
							<h4 class="card-title mb-1 text-4 font-weight-bold">Shri
								Arunkumar Pandit</h4>
				...
				<div class="col-md-3 col-lg-3 mb-5 mb-lg-0 appear-animation"
					...
					<div class="card">
						<img class="card-img-top"
							src="resources/front/img/Pujaris/BhargavBhatt-354-354.jpg"
							alt="Pujari Shri Bhargav Bhatt">
						<div class="card-body">
							<h4 class="card-title mb-1 text-4 font-weight-bold">Shri
								Bhargav Bhatt</h4>
							<!-- <p class="card-text mb-2 pb-1">Lorem ipsum dolor sit amet, consectetur adipiscing onsectetur adipiscing elit elit onsectetur adipiscing lit onsectetur adipiscing elit.</p>
				...
				<div class="col-md-3 col-lg3 mb-5 mb-lg-0 appear-animation"
					data-appear-animation="fadeInUpShorter"
					data-appear-animation-delay="200">
					<!-- <h4 class="mb-4">Image Top</h4> -->
			...
			<div class="row mb-5 mb-lg-0">
				...
				<div class="col-md-3 col-lg-3 mb-5 mb-lg-0 appear-animation"
					...
					<div class="card">
						<img class="card-img-top"
							src="resources/front/img/Pujaris/Pujari-Placeholder-354-354.jpg"
							alt="Pujari Smt. Nutunbala Bhatt">
						<div class="card-body">
							<h4 class="card-title mb-1 text-4 font-weight-bold">Smt.
								Nutunbala Bhatt</h4>
							<!-- <p class="card-text mb-2 pb-1">Lorem ipsum dolor sit amet, consectetur adipiscing onsectetur adipiscing elit elit onsectetur adipiscing lit onsectetur adipiscing elit.</p>
							<a href="/" class="read-more text-color-primary font-weight-semibold text-2">Read More <i class="fas fa-angle-right position-relative top-1 ms-1"></i></a> -->
						</div>
				...
				<div class="col-md-3 col-lg-3 mb-5 mb-lg-0 appear-animation"
					...
					<div class="card">
						<img class="card-img-top"
							src="resources/front/img/Pujaris/PriyeshBhatt-354-354-2.jpg"
							alt="Pujarai Shri Priyesh Bhatt">
						<div class="card-body">
							<h4 class="card-title mb-1 text-4 font-weight-bold">Shri
								Priyesh Bhatt</h4>
							<!-- <p class="card-text mb-2 pb-1">Lorem ipsum dolor sit amet, consectetur adipiscing onsectetur adipiscing elit elit onsectetur adipiscing lit onsectetur adipiscing elit.</p>
				...
				<!-- <div class="col-md-3 col-lg3 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
					<h4 class="mb-4">Image Top</h4>
