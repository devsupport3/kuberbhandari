...
<body>
	<div class="body ">
			...
			<div class="container my-3">
				<div class="row p-4">
					<div
						...
						<h1 class="font-weight-bold text-10">Booking Confirmed</h1>
					</div>
		...
		<div class="container1">
			...
			<p style="text-align: center;">Thank you for your booking. Your
				reservation has been successfully confirmed.</p>
			<p style="text-align: center;">
				Booking Number: <strong>#123456</strong>
			</p>
			<div class="booking-details">
				<strong style="color: #212529; font-size: larger;">Booking
					Summary:</strong>
				<p style="margin-top: inherit;">Name: Premium Lounge Access</p>
				<p>Date: 10th March 2025</p>
				<!-- <p>Time: 3:00 PM</p> -->
				<p>Total Price: $49.99</p>
			</div>
			<a href="<%=request.getContextPath()%>/" class="button">Back to Home</a>
		</div>
