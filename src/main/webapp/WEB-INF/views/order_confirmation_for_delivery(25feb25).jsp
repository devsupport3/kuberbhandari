...
<body>
	<div class="body ">
		...
		<section
			...
			<div class="container my-3" ng-controller="orderConfirmationCtrl"
				ng-init="getorderdetail('<%=session.getAttribute("ordernumber")%>')">
				<div class="row p-4">
					<div
						class="col-md-12 align-self-center p-static order-2 text-center">
						<h1 class="font-weight-bold text-10">Order Confirmed</h1>
					</div>
		...
		<div class="container1">
			...
			<p style="text-align: center;">Thank you for your purchase. Your
				order has been successfully placed.</p>
			<p style="text-align: center;">
				Order Number: <strong>#123456</strong>
			</p>
			<div class="order-details">
				<strong style="color: #212529; font-size: larger;">Order
					Summary:</strong>
				<p style="margin-top: inherit;">Name: Awesome Gadget</p>
				<p>Quantity: 2</p>
				<p>Total Price: $49.99</p>
				<p>Estimated Delivery: 3-5 Business Days</p>
			</div>
			<a href="<%=request.getContextPath()%>/" class="button">Back to
				Home</a>
			<!-- <a href="track-order.html" class="button" style="background: #ffc107;">Track Order</a> -->
		</div>
