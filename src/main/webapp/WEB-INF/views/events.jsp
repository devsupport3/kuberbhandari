...
<body>
	<div class="body ">
			...
			<div class="container my-3">
				<div class="row p-4">
					<div
						...
						<h1 class="font-weight-bold text-10">Events</h1>
					</div>
		...
		<div class="container mt-5" ng-controller="FrontEventController">

			<div class="row mt-5" ng-repeat="event in getAllActiveEvents">
				<div class=" appear-animation"
					...
					<div class="card">
						<div class="row g-0">
							<div class="col-lg-4">
								<img
									ng-src="<%=request.getContextPath()%>/resources/front/img/Events/{{event.eventsImages[0].eventImage}}"
									style="border-radius: 32px !important; width: 300px; height: 236px;"
									class="img-fluid rounded-start" alt="...">
							</div>
							<div class="col-lg-8">
								<div class="card-body">
									<h4 class="card-title mb-1 text-4 font-weight-bold"
										style="color: red">{{event.eventTitle}}</h4>
									<p>
										<i class="fa-regular fa-calendar" style="color: #ffad28"></i>
										&nbsp;{{event.eventDate}} </span> &nbsp; <span> <i
											class="fa-solid fa-location-dot" style="color: #ffad28"></i>
											&nbsp;{{event.eventLocation}}
										</span>
									</p>
									<!-- <p class="card-text mb-2">{{event.eventDescription}}</p> -->
									<span
										ng-bind-html="event.eventDescription | to_trusted "></span>
									<a href="#"
